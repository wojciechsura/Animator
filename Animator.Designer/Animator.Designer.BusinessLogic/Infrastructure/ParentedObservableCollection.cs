...
{
    public class ParentedObservableCollection<TItem, TParent> : Collection<TItem>, INotifyCollectionChanged, INotifyPropertyChanged
        ...
        where TParent : class
    {
        ...
        /// </summary>
        public ParentedObservableCollection(TParent parent) : base()
        {
            this.parent = parent;
        }
        ...
        public ParentedObservableCollection(TParent parent, List<TItem> list)
        ...
        public ParentedObservableCollection(TParent parent, IEnumerable<TItem> collection)
        {
            this.parent = parent;
