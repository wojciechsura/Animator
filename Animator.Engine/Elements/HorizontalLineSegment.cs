...
namespace Animator.Engine.Elements
{
    ...
    /// </summary>
    public partial class HorizontalLineSegment : LineBasedSegment
    {
        // Protected methods --------------------------------------------------
        ...
        public static readonly ManagedProperty XProperty = ManagedProperty.Register(typeof(HorizontalLineSegment),
            nameof(X),
            typeof(float),
